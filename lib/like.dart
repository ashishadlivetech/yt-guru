    ...
    try {
      ...
      List<Map<String, dynamic>> validVideos = fetchedVideos.where((video) {
        return video["url"] != null &&
            ...
            video["like_num_view"] != null &&
            video["like_num_view"].toString().isNotEmpty &&
                ...
                if (videos.isNotEmpty)
                  Row(
                    ...
                    children: [
                      _buildIconWithText(
                          Icons.favorite,
                          parseValue(videos[currentIndex]['like_num_view'])
                              .toString(),
                          "Points"),
                      _buildIconWithText(
                          Icons.access_time,
                          parseValue(videos[currentIndex]['like_time'])
                              .toString(),
                          "Seconds"),
                    ],
                  )
    ...
    return Column(
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
          children: [
            _buildGradientButton("Like", _openWebView),
