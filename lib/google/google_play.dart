...
class LoginPlayPage extends StatefulWidget {
  const LoginPlayPage({super.key});

  @override
  State<LoginPlayPage> createState() => _LoginPageState();
}

class _LoginPageState extends State<LoginPlayPage> {
  ...
  Future<String> sendLoginService() async {
    ...
    await Googleloginapiservice().sendGmailLogin("g.kiruthika36@gmail.com");
    ...
    if (responseMessage == 'Login Success') {
      authController.setEmail("g.kiruthika36@gmail.com"); // Save the email in GetStorage
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: TextFormField(
              initialValue: "g.kiruthika36@gmail.com",
              readOnly: true,
