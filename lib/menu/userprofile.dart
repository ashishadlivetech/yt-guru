...
class _UserProfilePageState extends State<UserProfilePage> {
  ...
  Future<void> _loadUserData() async {
    ...
    setState(() {
      // ✅ Keep input fields empty
      _fullNameController.text = "";
      _mobileNumberController.text = ""; // Reset mobile number field
      _selectedGender = null;
      _selectedDate = null;
    });
  }
  ...
  Future<void> _submitData() async {
    String fullName = _fullNameController.text;
    String mobileNumber = _mobileNumberController.text; // Mobile number input
    String gender = _selectedGender ?? "";
    ...
    if (fullName.isNotEmpty && mobileNumber.isNotEmpty) {
      await userController.updateUserData(fullName, mobileNumber, gender, dob);
      await _loadUserData();
      _fullNameController.clear();
                ...
                children: [
                  ...
                  TextFormField(
                      ...
                      decoration: InputDecoration(
                          labelText: "Mobile Number")), // Use mobile number
                  const SizedBox(height: 10),
                  DropdownButtonFormField<String>(
                    value: _selectedGender,
                    items: ["Male", "Female", "Other"].map((String gender) {
