...
class CreateTitlePage extends StatefulWidget {
  ...
  @override
  _CreateTitlePageState createState() => _CreateTitlePageState();
}
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Create the most suitable title for your content with the Artificial Intelligence supported video title creation tool.',
